...
# Correct path to solutions directory
solution_path = os.path.abspath(os.path.join(os.path.dirname(__file__), '../solutions'))
sys.path.insert(0, solution_path)

from solution import Solution, Node  # This should now work
